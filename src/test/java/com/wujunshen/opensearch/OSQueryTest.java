...
public class OSQueryTest {
  ...
  public void init() throws IOException {
    ...
    Sku sku21 = new Sku(21L, "YD001", "LiNing1", "Green", "2XL", 4000);
    Sku sku22 = new Sku(22L, "YD002", "LiNing2", "Green", "L", 3000);
    Sku sku23 = new Sku(23L, "YD003", "LiNing3", "Green", "M", 5000);
    ...
    spu3.setProductName("People's Republic of China");
    spu3.setBrandCode("YD-001");
    spu3.setBrandName("mickey mouse");
    spu3.setCategoryCode("YDC-001");
    spu3.setCategoryName("dress");

    Sku sku31 = new Sku(31L, "LS001", "hat1", "Red", "L", 4000);
    Sku sku32 = new Sku(32L, "LS002", "hat2", "Yellow", "M", 3000);
    Sku sku33 = new Sku(33L, "LS003", "hat3", "Green", "2XL", 5000);
  ...
  public void matchQuery() throws IOException {
    List<Spu> result =
        queryApi.matchQuery(
            indexName, "android mobile", "productName", "id", 0, 1, true, Spu.class);
  ...
  public void multiMatchQuery() throws IOException {
    ...
    List<Spu> result =
        queryApi.multiMatchQuery(
            indexName, "People's Republic", fields, "id", 0, 1, true, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void termQuery() throws IOException {
    List<Spu> result =
        queryApi.termQuery(indexName, "android", "productName", "id", 0, 1, true, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    result =
        queryApi.termQuery(indexName, "android mobile", "productName", "id", 0, 1, true, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void fuzzyQuery() throws IOException {
    List<Spu> result =
        queryApi.fuzzyQuery(indexName, "Li", "brandName", "id", 0, 1, true, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));

    assertThat(result, notNullValue());
    assertThat(result.size(), equalTo(0));

    result = queryApi.fuzzyQuery(indexName, "LiNing", "brandName", "id", 0, 1, true, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void matchPhrasePrefixQuery() throws IOException {
    List<Spu> result =
        queryApi.matchPhrasePrefixQuery(
            indexName, "People's Republic", "productName", "id", 0, 1, true, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
    ...
    result =
        queryApi.matchPhrasePrefixQuery(
            indexName, "mouse", "brandName", "id", 0, 1, true, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void rangeQuery() throws IOException {
    List<Spu> result =
        queryApi.rangeQuery(
            indexName, "android", "swear", "productName", "id", 0, 3, false, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void wildcardQuery() throws IOException {
    // avoid start by "*", it will retrieve a lot of content causing slow efficiency, here is just
    // an example
    List<Spu> result =
        queryApi.wildcardQuery(indexName, "*", "productName", "id", 0, 3, false, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void constantScoreQuery() throws IOException {
    List<Spu> result =
        queryApi.constantScoreQuery(
            indexName, "android", "productName", 0.2f, "id", 0, 3, false, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void disMaxQuery() throws IOException {
    ...
    Query qb2 = Query.of(q -> q.term(t -> t.field("brandName").value(FieldValue.of("LiNing"))));

    queries.add(qb1);
    queries.add(qb2);

    List<Spu> result =
        queryApi.disMaxQuery(indexName, queries, 1.3f, 0.7d, "id", 0, 3, false, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void queryStringQuery() throws IOException {
    List<Spu> result =
        queryApi.queryStringQuery(indexName, "+android", "id", 0, 3, false, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void spanFirstQuery() throws IOException {
    List<Spu> result =
        queryApi.spanFirstQuery(
            indexName, "android", "productName", 30000, "id", 0, 3, false, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
  ...
  public void spanTermQuery() throws IOException {
    List<Spu> result =
        queryApi.spanTermQuery(indexName, "android", "productName", "id", 0, 3, false, Spu.class);
    result.forEach(spu -> log.info(String.valueOf(spu)));
