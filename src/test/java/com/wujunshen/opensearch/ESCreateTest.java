...
public class ESCreateTest {
	...
	public void operateData() throws IOException {
		...
		GetResponse<Spu> getResponse = documentApi.getDocument(indexName, String.valueOf(spu1.getId()),
				Spu.class);

		assertThat(getResponse.id(), notNullValue());
		assertThat(getResponse.id(), is("1"));

		DeleteResponse deleteResponse = documentApi.deleteDocument(indexName,
				String.valueOf(spu1.getId()));
